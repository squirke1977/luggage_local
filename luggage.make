...
l_Library_Scripts_ThoughtWorks: l_Library
	@sudo mkdir -p ${WORK_D}/Library/Scripts/ThoughtWorks
	@sudo chown root:wheel ${WORK_D}/Library/Scripts/ThoughtWorks
	@sudo chmod 755 ${WORK_D}/Library/Scripts/ThoughtWorks
...
l_opt_cisco_anyconnect_profile: l_opt_cisco_anyconnect_profile
	@sudo mkdir -p ${WORK_D}/opt/cisco/anyconnect/profile
	@sudo chown root:wheel ${WORK_D}/opt/cisco/anyconnect/profile
	@sudo chmod 755 ${WORK_D}/opt/cisco/anyconnect/profile
	
l_.certs: l_.certs
	@sudo mkdir -p ${WORK_D}/.certs
	@sudo chown root:wheel ${WORK_D}/.certs
	@sudo chmod 755 ${WORK_D}/.certs
	
l_usr_local_munki: l_usr_local_munki
